...
%fprintf('Here is X before featureNormalize\n');
%X(1:10,:)

[X mu sigma] = featureNormalize(X);

%fprintf('Here is X after featureNormalize\n');
%X(1:10,:)

% Add intercept term to X
X = [ones(m, 1) X];

%fprintf('Here is X after adding one column\n');
%X(1:10,:)
...
%fprintf('Here is X before calling multiDescent\n');
%X(1:10,:)
